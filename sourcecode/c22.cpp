...
double *aux;
aux = (double*) x.value;
if((e1.compare("Libre") == 0) && (x.port == 0) && (optimo() == 1)){
    counter_aux++;
	destino1 = *aux;
	...
	if((e1.compare("Ocupado") == 0) && (x.port == 0) && (optimo() == 1)){
        counter_aux++;
		tiempo1 = tiempo1 -e;
        ult_dest1 = *aux;
		cola1.push(*aux);
		...
		if((e2.compare("Libre") == 0) && (x.port == 0) && (optimo() == 2)){
            counter_aux++;
			tiempo1 = tiempo1 -e;
			destino2 = *aux ;
            ult_dest2 = *aux;			
			...
			if((e2.compare("Ocupado") == 0) && (x.port == 0) && (optimo() ==2)){
                counter_aux++;
				tiempo1 = tiempo1-e;
				tiempo2 = tiempo2-e;
                ult_dest2 = *aux;			
