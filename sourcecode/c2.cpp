#include "c2.h"
double c2::minimo(double val1, double val2){
if (val1 <= val2){
	return val1;
}else{
	return val2;
...
bool c2::disponibilidad(){
	return (e1.compare("Libre") == 0 || e2.compare("Libre") == 0);
}
double c2::optimo(double t){
    if (counter_aux%2==0){
        return 1;
    }else{
        return 2;
...
double c2::ta(double t) {
//This function returns a double.
printLog("\nTA controlador\n");
return minimo(tiempo1,tiempo2);
}
void c2::dint(double t) {
